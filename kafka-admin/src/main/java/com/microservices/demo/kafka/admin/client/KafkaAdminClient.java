...
public class KafkaAdminClient {
    ...
    public KafkaAdminClient(
            KafkaConfigData kafkaConfigData, RetryConfigData retryConfigData, AdminClient adminClient,
    ...
    private Collection<TopicListing> doGetTopics(RetryContext retryContext)
        ...
        log.info("Reading {} topics, attempt {}", kafkaConfigData.getTopicNamesToCreate().toArray(),
